...
export function JambAdmissionLetter() {
  return (
    <>
      ...
      <section className="card">
        <h1 className="result-heading">JAMB Admission Letter</h1>
        <Caution>
          <ul>
            <li>Fill all your details correctly.</li>
            <li>
              After you fill your details, Make payment and you will be
              contacted within an hour. Your JAMB admission Letter will be forwarded
